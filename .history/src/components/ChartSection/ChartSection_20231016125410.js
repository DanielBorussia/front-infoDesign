            ...
            {sections.length > 0 && (
                <Grid container spacing={3}>
                    <Grid item xs={4}>
                        ...
                        <p>{JSON.stringify(dataConsumos)}</p>
                        <p>{JSON.stringify(labels)}</p>
                        <LineChart
                            width={400}
                            height={300}
                            series={[
                                { data: [138468,136205,138721,135474,125265], label: 'Consumo' },
                            ]}
                            xAxis={[{ scaleType: 'point', data: ["Tramo 1","Tramo 2","Tramo 3","Tramo 4","Tramo 5"] }]}
                        />
                        </Box>
                    </Grid>
                </Grid>
