...
const ChartSection = ({ dateRange }) => {
    const [data, setData] = useState(
        JSON.parse('{"labels":["Tramo 1","Tramo 2","Tramo 3","Tramo 4"," Tramo 5"],"datasets":[{"label":"Consumo","data":[138468,136205,138721,135474,125265],"backgroundColor":"rgba(255, 99, 132, 0.5)"},{"label":"Perdidas","data":[15.421322279999996,12.952212818999998,12.415644742,14.191845920999999,12.344276639000002],"backgroundColor":"rgba(53, 162, 235, 0.5)"}]}')
    );
